...
@section('content')
    <div class="col-xl-10">
        ...
        <form class="align-content-center" method="Post" action="/admin/users" enctype="multipart/form-data" style="">
            ...
            <input class="form-control m-2" type="text" name="name" placeholder="نام و نام خانوادگی خود را وارد کنید"
                   style="color: #101010; font-size: 10pt;">

            <label for="email">ایمیل:</label>
            <input class="form-control m-2" type="text" name="email" placeholder="برای مثال Code@facaulty.com"
                   style="color: #101010; font-size: 10pt;">
            ...
            <input class="form-control m-2" type="text" name="password" placeholder="رمز عبور را وارد کنید"
                   style="color: #101010; font-size: 10pt;">
